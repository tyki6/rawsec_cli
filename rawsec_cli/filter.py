def filterProjects(projects, lang=None, price=False, free=False, online=False, offline=False, blackarch=False):
    if lang is not None and lang != "":
        projects = [project for project in projects if "language" in project and not lang.lower() != project["language"].lower()]
